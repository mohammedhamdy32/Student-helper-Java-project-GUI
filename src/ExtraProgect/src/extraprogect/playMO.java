...
//        }
     ...
     void action_index_1 (int p)
     {
         ...
         if(owenr==0)
         {
            int x= JOptionPane.showConfirmDialog(this, "Do you want to buy this place?\nIt's price is 500 L.E");
            if(x==0){
                owenr=p;
                if(p==1)
         ...
         if(p!=owenr){
            ...
            money_p1=money_p1-200;
             money_p2=money_p2+200;
             JOptionPane.showMessageDialog(this, p1+", you are in the place of "+p2+"pay 200L.E for "+p2);
            }else
            {
                money_p1=money_p1+200;
             money_p2=money_p2-200;
              JOptionPane.showMessageDialog(this, p2+", you are in the place of "+p1+"pay 200L.E for "+p1);
      ...
      void action_index_4(int p)
    {
         ...
         if(p!=owenr3){
            ...
            money_p1=money_p1-100;
             ...
             JOptionPane.showMessageDialog(this, p1+", you are in the place of "+p2+"pay 100L.E for "+p2);
            }else
            {
                money_p1=money_p1+100;
             money_p2=money_p2-100;
              JOptionPane.showMessageDialog(this, p2+", you are in the place of "+p1+"pay 100L.E for "+p1);
        ...
        if(owenr2==0)
         ...
         if(p!=owenr2){
            ...
            money_p1=money_p1-50;
             ...
             JOptionPane.showMessageDialog(this, p1+", you are in the place of "+p2+"pay 50L.E for "+p2);
            }else
            {
                money_p1=money_p1+50;
             money_p2=money_p2-50;
              JOptionPane.showMessageDialog(this, p2+", you are in the place of "+p1+"pay 50L.E for "+p1);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 20, -1, 40));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(865, 143, 231, 31));
        getContentPane().add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 595, 50, 10));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 509, 114, -1));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1065, 509, 95, -1));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 400, 330, 50));

        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/aa22f7bd40726af6afd9c54799b3cbe996ade4542b502f08f8d64e832f2e18b1._RI_.jpg"))); // NOI18N
        getContentPane().add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 570));
